...
HTTP POST endpoint and accepts a JSON payload. [Podinfo](https://github.com/richardcase/podinfo) 
...
The `podinfo` and `ngrok` charts are hosted on GitHub. Add the podinfo repo:
